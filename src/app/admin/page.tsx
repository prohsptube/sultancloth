        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border-2 border-red-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none bg-red-50 text-gray-800 placeholder:text-gray-400"
              required
            />
          </div>
